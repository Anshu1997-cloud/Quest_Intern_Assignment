...
const HeroSection3 = () => {
  return (
    <div  className="bg-[#0D0D0D] min-h-screen">
              <p style={{ marginTop:'7rem',color: 'white', textAlign: 'center', fontWeight: '500', fontSize: '60px', lineHeight: '40px', letterSpacing: '0.96px', fontFamily: 'sans-serif', margin: 'auto', maxWidth: '100'}}>
    ...
    <p style={{ 
      ...
      <div style={{display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '20px' , marginTop:'7rem', border: '2px solid #ccc' , maxWidth: '40vw', marginLeft:'30%',  padding: '15px', borderRadius:'10px' }} >
          <div className = 'app-card'><img src="https://www.questlabs.ai/assets/snowflack-X_nYrDCM.svg"/></div>
          <div class = 'app-card'>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 49" style={{width: "100", height: "100"}}>
        <g clip-path="url(#clip0_4514_7702)">
      ...
      <div style={{position: "absolute", top: "165%", marginLeft: "33rem" }} >
...
<p style={{textAlign: "center", fontSize: "30px", lineHeight: "28px", color: "#B9B9B9", fontFamily: 'sans-serif', fontWeight: "normal", marginTop: "200px", marginLeft: "auto", marginRight: "auto"}}>Dynamic &amp; Intelligent experiences</p>
<p style={{paddingLeft: "1rem", paddingRight: "1rem", color: "#ffffff", textAlign: "center", fontWeight: "500", fontSize: "40px", lineHeight: "40px", letterSpacing: "-0.96px", fontFamily: 'sans-serif', maxWidth: "1100px", marginLeft: "auto", marginRight: "auto", marginTop: "3rem"}}>
